...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 199 --manuf-id 0x1219 --image-type 29 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL HiddenSingleFireSwitch_Z3SE_SDK6630"':
        sys.exit(0)
    print (" ")
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 199 --manuf-id 0x1219 --image-type 29 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL HiddenSingleFireSwitch_Z3SE_SDK6630"'.replace("\t", "\\t")
