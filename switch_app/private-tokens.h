...
#define CREATOR_CUSTOM_AUTH_CODE			     	 0x0034		//网关授权
#define CREATOR_CUSTOM_NODE_TYPE					 0x0035		//节点类型
#define CREATOR_CUSTOM_SWITCH_TYPE					 0x0036		//开关类型
...
#define NVM3KEY_CUSTOM_AUTH_CODE   					 0x0034     //网关授权
#define NVM3KEY_CUSTOM_NODE_TYPE                     0x0035		//节点类型
#define NVM3KEY_CUSTOM_SWITCH_TYPE                   0x0036		//开关类型
...
// Types for the tokens
  ...
  typedef struct {
	uint8_t code[25];                //24Byte的授权码，+ 1个结束符
  } tTokenTypeCustomAuthCode;  
#endif // DEFINETYPES
...
// Actual token definitions
  ...
  DEFINE_BASIC_TOKEN(CUSTOM_AUTH_CODE,  		 tTokenTypeCustomAuthCode, {0x00,})
